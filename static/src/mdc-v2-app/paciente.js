...
class Paciente extends PolymerElement {
  static get template() {
    return html`
		  ...
		  <div class="data">
			  ...
			  <input type="text" id="tipo_sangre" style="width: 20%;">
			  <input type="text" id="rh" style="width: 20%;" placeholder="RH"><br>
			  ...
			  <select id="plan_beneficios">
				  ...
				  <option value="Plan de atención básica en salud. PAB.">
				  	Plan de atención básica en salud. PAB.</option>
				  <option value="Plan obligatorio de salud del régimen contributivo. POS.">
				  	Plan obligatorio de salud del regimen contributivo. POS.</option>
				  <option value="Plan obligatorio de salud del regimen subsidiado. POS-S">
				  	Plan obligatorio de salud del regimen subsidiado. POS-S</option>
				  <option value="Atención en accidentes de transito y eventos catastroficos. SOAT">
				  	Atención en accidentes de transito y eventos catastroficos. SOAT</option>
				  <option value="Atención inicial de urgencias">
				  	Atención inicial de urgencias</option>
				  <option value="Planes Complementarios En Salud (Pacs)">
				  	Planes Complementarios En Salud (Pacs)</option>
				  <option value="Atención Materno-infantil">
				  	Atención Materno-infantil</option>
			  </select>
		  </div>
  ...
  getPaciente(evento, solicitud) {
    ...
    this.$.tipo_usuario.value = datos['tipoUsuario'];
    ...
    this.$.direccion.value = datos['direccion'];
	...
	document.getElementById("mdc").prueba("envio")
    //console.log(prueba);
  }
