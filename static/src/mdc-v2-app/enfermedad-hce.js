...
class EnfermedadHce extends PolymerElement {
  static get template() {
    return html`
		...
		<paper-card>
			...
			<br>
				<select id = "causa">
					<option value ="01 = Accidente de trabajo">
						01 = Accidente de trabajo</option>
					<option value ="02 = Accidente de tránsito">
						02 = Accidente de tránsito</option>
					<option value ="03 = Accidente rábico">
						03 = Accidente rábico</option>
					<option value ="04 = Accidente ofídico">
						04 = Accidente ofídico</option>
					<option value ="05 = Otro tipo de accidente">
						05 = Otro tipo de accidente</option>
					<option value ="06 = Evento catastrófico">
						06 = Evento catastrófico</option>
					<option value ="07 = Lesión por agresión">
						07 = Lesión por agresión</option>
					<option value ="08 = Lesión auto inflingida">
						08 = Lesión auto inflingida</option>
					<option value ="09 = Sospecha de maltrato físico">
						09 = Sospecha de maltrato físico</option>
					<option value ="10 = Sospecha de abuso sexual">
						10 = Sospecha de abuso sexual</option>
					<option value ="11 = Sospecha de violencia sexual">
						11 = Sospecha de violencia sexual</option>
					<option value ="12 = Sospecha de maltrato emocional">
						12 = Sospecha de maltrato emocional</option>
					<option value ="13 = Enfermedad general">
						13 = Enfermedad general</option>
					<option value ="14 = Enfermedad profesional">
						14 = Enfermedad profesional</option>
  ...
  setDiagnostico(cadena){
	  this.$.texto.value = cadena;
  }
  getCausa(){
	return this.$.causa.value;
  }
  setCausa(cadena){
	this.$.causa.value=cadena;
  }
  getFin(){
	return this.$.fin.value;
  }
  setFin(cadena){
	this.$.fin.value = cadena;
  }
  getTipo(){
